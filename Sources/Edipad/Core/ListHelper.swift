...
public enum ListKind: Equatable {
...
public struct ListMatch: Equatable {
    public let indent: String       // leading whitespace
    public let prefix: String       // marker text: "- ", "1. ", "- [ ] ", "- [x] "
    public let kind: ListKind
    public let contentStart: Int    // char offset from line start where content begins

    public init(indent: String, prefix: String, kind: ListKind, contentStart: Int) {
        self.indent = indent
        self.prefix = prefix
        self.kind = kind
...
public enum ListHelper {

    public static func isKindEnabled(_ kind: ListKind, settings: EditorSettings) -> Bool {
        switch kind {
        case .bullet: return settings.bulletListsEnabled
        case .ordered: return settings.numberedListsEnabled
        case .unchecked, .checked: return settings.checklistsEnabled
        }
    }
    ...
    public static func parseLine(_ line: String) -> ListMatch? {
    ...
    public static func nextPrefix(for match: ListMatch) -> String {
        let marker: String
        switch match.kind {
        case .bullet(let ch):
            marker = "\(ch) "
    ...
    public static func isEmptyItem(_ line: String, match: ListMatch) -> Bool {
    ...
    public static func toggleChecklist(line: String) -> String {
