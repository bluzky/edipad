...
public final class LineNumberGutterView: NSView {
    ...
    public var lineFont: NSFont = .monospacedSystemFont(ofSize: 11, weight: .regular) { didSet { needsDisplay = true } }
    public var lineColor: NSColor = .secondaryLabelColor { didSet { needsDisplay = true } }
    public var bgColor: NSColor = .textBackgroundColor { didSet { needsDisplay = true } }

    private static let rightPadding: CGFloat = 8

    public func attach(to scrollView: NSScrollView, textView: NSTextView) {
    ...
    public static func calculateWidth(lineCount: Int, font: NSFont) -> CGFloat {
    ...
    public func updateVisibility(_ visible: Bool, lineCount: Int) {
