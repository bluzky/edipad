...
public class HighlightJS {
    ...
    public private(set) var backgroundColor: NSColor = .black
    public private(set) var foregroundColor: NSColor = .white
    ...
    private func ensureLoaded() -> JSValue? {
        ...
        guard let jsContext = JSContext(),
              let jsPath = Bundle.module.path(forResource: "highlight.min", ofType: "js"),
    ...
    public func setTheme(css: String) {
    ...
    public func loadTheme(named name: String) -> Bool {
    ...
    public func setCodeFont(_ font: NSFont) {
        codeFont = font
    }

    public func highlight(_ code: String, as language: String) -> NSAttributedString? {
    ...
    public func highlightAuto(_ code: String) -> AutoResult? {
