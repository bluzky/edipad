...
public struct LanguageDetector {
    ...
    public static let allLanguages: [String] = [
    ...
    public struct Result {
        ...
        public init(lang: String, confidence: Int) {
            self.lang = lang
    ...
    public func detectFromExtension(name: String) -> String? {
        let parts = name.split(separator: ".")
    ...
    public func highlightrLanguage(for lang: String) -> String? {
